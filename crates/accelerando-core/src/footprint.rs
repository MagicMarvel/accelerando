...
#[serde(tag = "kind")]
pub enum Plot {
    /// Color the background band behind this footprint (e.g. regime coloring).
...
pub struct Footprint {
    ...
    /// Numeric indicator outputs (e.g. `"score" -> 0.83`).
    pub values: BTreeMap<String, f64>,
    /// Categorical indicator outputs (e.g. `"regime" -> "trend_up"`).
