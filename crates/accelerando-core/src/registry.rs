...
//! whole config-driven toolchain (CLI, hyperopt search space, studio form) picks them up.
//!
...
//! and the studio's backtest thread.
...
impl Registry {
    ...
    // --- introspection (for hyperopt search space + studio schema) ----------------------------
