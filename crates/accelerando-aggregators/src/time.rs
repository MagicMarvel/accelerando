...
/// Aggregates trades into fixed-duration footprints, mirroring the bucketing of the original
/// price-shape-regime detector but producing a full bid/ask ladder.
